...
/**
 * Created by Here on 2/5/2017.
 */
public class Utilsa3a1a2 {
    ...
    public static Point CalcD12PerpCoord(double D12, double velocity,
                                         double t2, double t3) {
        return new Point((D12 + velocity * (t3 - t2)/2), 0);
    }
